                  ...
                  <div className="flex-1 space-y-6 sm:space-y-8 w-full">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5 pt-6 sm:pt-8 border-t border-slate-100">
                      ...
                      <Link
                        ...
                        className="group w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-3 sm:py-3 bg-linear-to-r from-indigo-600 via-indigo-700 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-extrabold text-xs sm:text-sm rounded-xl border border-indigo-400/30 transition-all duration-200 shadow-md shadow-indigo-500/20 hover:shadow-lg hover:shadow-indigo-500/35 hover:scale-[1.03] active:scale-[0.98] shrink-0 cursor-pointer"
                      >
                        <span className="flex items-center gap-1.5">
                          <svg className="w-3.5 h-3.5 fill-current text-indigo-200" viewBox="0 0 24 24">
                            <path d="M8 5v14l11-7z" />
                          </svg>
                          <span>See Testimonials</span>
                        </span>
                        <svg className="w-4 h-4 text-indigo-200 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
