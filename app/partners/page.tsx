      ...
      <div className="w-full md:w-64 bg-white border-b md:border-b-0 md:border-r border-slate-200 flex flex-col shrink-0 z-10">
        <div className="p-6 border-b border-slate-100 bg-slate-50 flex justify-between md:flex-col md:items-start md:space-y-4">
          <div>
            ...
            <p className="text-[10px] uppercase font-bold text-slate-400 tracking-widest mt-1">Get Involved with INI</p>
          </div>
        </div>
      ...
      <div className="flex-1 h-full overflow-y-auto selection:bg-indigo-100 selection:text-indigo-900 pb-24">
          ...
          <div className="animate-in fade-in duration-300">
            ...
            <section className="relative bg-slate-900 text-white pt-16 pb-16 overflow-hidden">
              <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute -top-1/4 -left-1/4 w-[700px] h-[700px] rounded-full bg-gradient-to-br from-indigo-600/20 to-purple-600/10 blur-3xl" />
                <div className="absolute -bottom-1/3 -right-1/4 w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-blue-600/25 to-slate-900/10 blur-3xl" />
              </div>

              <div className="max-w-4xl mx-auto px-6 relative z-10">
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-semibold text-indigo-200 mb-4 backdrop-blur-md">
                ...
                <p className="text-sm md:text-base text-slate-300 max-w-2xl leading-relaxed">
                  The Institute for Nonpartisan Innovation (INI) helps CUNY faculty, students, and campus programs collaborate on real-world civic challenges through applied research, interdisciplinary projects, and cross-campus innovation initiatives.
                </p>
              </div>
            </section>
            ...
            <section className="max-w-4xl mx-auto px-6 -mt-8 relative z-20">
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-100 space-y-4">
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-lg font-extrabold text-slate-900 mb-0.5">What INI Enables</h2>
                    <p className="text-slate-600 text-sm leading-relaxed">
                      INI organizes implementation labs, fellowships, and cohort-based programs where students work alongside faculty and external partners on applied civic systems and research initiatives aligned with campus strengths and academic priorities.
                    </p>
                  </div>
                </div>
                ...
                <div className="border-t border-slate-100 pt-4">
                  <p className="text-slate-600 text-xs leading-relaxed">
                    <strong>Fellowship Impact:</strong> Each semester, stipend-supported INI student fellows across CUNY help maintain and expand the collaboration network while contributing to projects connected to civic technology, public-interest research, and community impact.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="max-w-4xl mx-auto px-6 py-12">
              <div className="mb-10 text-center sm:text-left">
                <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight mb-2">Example Collaboration Areas</h2>
                <p className="text-slate-500 text-sm">See how CUNY faculty and students have worked with leading civic organizations to create state-level and city-wide impacts.</p>
              </div>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {collaborationAreas.map((collab, idx) => (
                  <div key={idx} className={`p-6 rounded-2xl border transition-all duration-300 hover:shadow-md flex flex-col justify-between ${collab.color}`}>
                    <div>
                      <span className={`inline-block px-2.5 py-0.5 rounded-full text-[10px] font-bold mb-4 ${collab.badgeColor}`}>
                        {collab.badge}
                      </span>
                    ...
                    {collab.bullets && (
                      <div className="border-t border-purple-200/40 pt-4 mt-2">
                        <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2.5">Key Focus Pillars</h4>
            ...
            <section className="bg-slate-100 border-y border-slate-200 py-12">
              <div className="max-w-4xl mx-auto px-6">
                <div className="text-center sm:text-left mb-10">
                  <h2 className="text-2xl font-extrabold text-slate-900 mb-2 tracking-tight">How INI Works with Campuses</h2>
                  <p className="text-slate-500 text-sm">INI collaborates with college ecosystems across three primary dimensions to establish flexible engagement models.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                  {campusPillars.map((pillar, idx) => (
                    <div key={idx} className="bg-white p-5 rounded-xl border border-slate-200/60 shadow-sm">
                      <div className="w-10 h-10 rounded-lg bg-indigo-50 border border-indigo-100 flex items-center justify-center mb-4 shrink-0">
                        {pillar.icon}
                      </div>
                ...
                <div className="bg-white border border-slate-200 p-6 rounded-2xl max-w-2xl mx-auto shadow-sm text-center">
                  <h3 className="font-extrabold text-slate-900 mb-4 uppercase text-[10px] tracking-wider">Available Participation Models</h3>
            ...
            <section className="max-w-4xl mx-auto px-6 py-12">
              <div className="mb-10 text-center sm:text-left">
                <h2 className="text-2xl font-extrabold text-slate-900 mb-2 tracking-tight">Strategic Value for CUNY</h2>
                <p className="text-slate-500 text-sm">Strengthening and amplifying existing campus initiatives through structural civic support.</p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {strategicValues.map((value, idx) => (
                  <div key={idx} className="flex gap-4 items-start bg-white p-5 rounded-xl shadow-sm border border-slate-100 hover:border-slate-200 transition-all">
            ...
            <section className="max-w-4xl mx-auto px-6 mb-4">
              <div className="relative rounded-2xl p-6 md:p-10 bg-gradient-to-br from-indigo-900 via-slate-950 to-slate-950 text-white shadow-xl overflow-hidden border border-white/5">
                <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500/10 rounded-full blur-[80px] pointer-events-none" />
                <div className="relative z-10">
                  <span className="inline-block px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-white/10 text-indigo-300 border border-white/10 mb-4 uppercase tracking-wider">
                  ...
                  <p className="text-slate-300 text-xs md:text-sm mb-6 leading-relaxed max-w-xl">
                    We welcome collaboration with faculty, research centers, academic departments, and campus programs across CUNY. Let's explore how INI can support your campus, students, and community partnerships.
                  </p>

                  <div className="border-t border-white/10 pt-4 mb-6">
                    <h3 className="font-bold text-[10px] uppercase text-slate-400 tracking-wider mb-3">Potential Collaboration Areas</h3>
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-200">
                      <li className="flex items-center gap-2"><span className="text-indigo-400">✓</span> Coursework project integration</li>
                      <li className="flex items-center gap-2"><span className="text-indigo-400">✓</span> Co-developing research / tech</li>
                      <li className="flex items-center gap-2"><span className="text-indigo-400">✓</span> Student engagement pathways</li>
                      <li className="flex items-center gap-2"><span className="text-indigo-400">✓</span> Cross-campus collaborations</li>
                    </ul>
                  </div>
        ...
        {activeTab === "student" && (
          <div className="animate-in fade-in duration-300">
            ...
            <section className="relative bg-slate-900 text-white pt-16 pb-16 overflow-hidden">
              <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute -top-1/4 -right-1/4 w-[700px] h-[700px] rounded-full bg-gradient-to-br from-indigo-600/20 to-purple-600/10 blur-3xl" />
                <div className="absolute -bottom-1/3 -left-1/4 w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-emerald-600/25 to-slate-900/10 blur-3xl" />
              </div>

              <div className="max-w-4xl mx-auto px-6 relative z-10">
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-semibold text-emerald-200 mb-4 backdrop-blur-md">
                ...
                <p className="text-sm md:text-base text-slate-300 max-w-2xl leading-relaxed">
                  Every semester, INI student fellows across CUNY help maintain, strengthen, and expand the discovery network. Gain hands-on learning while building public-interest tech and civic systems.
                </p>
              </div>
            </section>
            ...
            <section className="max-w-4xl mx-auto px-6 -mt-8 relative z-20">
              <div className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white p-6 rounded-2xl shadow-lg">
                ...
                <p className="text-emerald-50 text-xs md:text-sm leading-relaxed max-w-3xl">
                  We are developing a first-of-its-kind discovery engine to bridge the gap between CUNY researchers, students, and civic leaders. We are looking for ambitious communicators, developers, data scientists, and community ambassadors.
                </p>
              </div>
            </section>
            ...
            <section className="max-w-4xl mx-auto px-6 py-12">
              <div className="mb-10 text-center sm:text-left">
                <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight mb-2">Who We Are Looking For</h2>
                <p className="text-slate-500 text-sm">We recruit interdisciplinary student contributors across 25 CUNY campuses for multiple core skillsets.</p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                {studentCategories.map((cat, idx) => (
                  <div key={idx} className="bg-white p-5 rounded-xl border border-slate-200/60 shadow-sm flex items-start gap-4">
              ...
              {/* Roles Available */}
              <div className="mb-10 text-center sm:text-left">
                <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight mb-2">Roles Available</h2>
                <p className="text-slate-500 text-sm">These roles form active semester-long cohorts designed to strengthen CUNY's civic tech infrastructure.</p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {specificRoles.map((role, idx) => (
                  <div key={idx} className="bg-slate-50/50 p-5 rounded-xl border border-slate-200/40 hover:border-slate-200 transition-all flex items-start gap-3">
            ...
            <section className="max-w-4xl mx-auto px-6 mb-4">
              <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-sm text-center">
                ...
                <p className="text-slate-600 text-xs md:text-sm mb-6 max-w-md mx-auto leading-relaxed">
                  Join the team building civic infrastructure for 25 CUNY campuses. Accelerate your career with real-world learning.
                </p>
                <a
                  href={GOOGLE_FORM_URL}
                  target="_blank"
