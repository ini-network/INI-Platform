...
import { formatNewsDate, type NewsListItem, type NewsListResponse } from "../../lib/news";
import { openNewsModal } from "../../lib/news-modal-store";
import { markNewsRead } from "../../lib/news-read";
import { buildEvidenceLine } from "../../lib/signal-briefing";
import { isEmerging, type NeighborhoodSignal } from "../../lib/signal-types";
import { TOUR_NEWS, TOUR_SIGNALS } from "../../lib/tour-fixtures";
